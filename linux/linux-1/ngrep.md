...
ngrep命令的下载地址：[http://ngrep.sourceforge.net/，libpcap下载地址：http://www.tcpdump.org/。先用\`yum](http://ngrep.sourceforge.net/，libpcap下载地址：http://www.tcpdump.org/。先用`yum) install libpcap\`完全安装libpcap，注意有时候用libpcap安装包安装的不完整会影响ngrep的使用。
...
OK。地址已经找到了,就是[http://f59.c31.56.com/flvdownload/12/19/ggyg7741@56.com\_56flv\_zhajm\_11955697397.flv](http://f59.c31.56.com/flvdownload/12/19/ggyg7741@56.com_56flv_zhajm_11955697397.flv)
