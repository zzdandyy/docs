...
首先，输入“ root \(hd ” ，然后按两次 TAB 键； / _这会列出你电脑上可能的磁盘设备，硬盘为 hd0/hd1 或 sd0/sd1 等_ /

然后，选择你的安装 Linux 系统的硬盘，比如 hd0 ，输入 “ root \(hd0, ” 再按两次 TAB 键； / _这会列出你的第一块硬盘上的分区情况，你会知道哪个是 swap 交换分区， 0x82 ，哪个是 Linux 分区 0x83_ /
